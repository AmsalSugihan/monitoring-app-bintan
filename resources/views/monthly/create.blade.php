...
<div class="container-fluid px-4">
    ...
    @endif
    <form action="{{ route('monthly.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row gx-4">
            <div class="col-lg-8">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" id="bulan" name="bulan" value="{{Carbon::now()->format('F')}}">
                        <input type="hidden" id="tahun" name="tahun" value="{{Carbon::now()->format('Y')}}">
                        <div class="row gx-3 mb-3">
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputTahun">Tahun</label>
                                <input class="form-control" name="tanggal" id="inputTahun" type="text" value="{{Carbon::now()->format('Y')}}" disabled/>
                            </div>
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputBulan">Bulan</label>
                            <input class="form-control" name="bulan" id="inputBulan" type="text" value="{{Carbon::now()->format('F')}}" disabled/>
                            </div>
                        </div>
                        <div class="row gx-3 mb-3">
                            <div class="col-md-4">
                                <label class="small mb-1" for="suhu_ruang">Suhu Ruang</label>
                                <input class="form-control" name="suhu_ruang" id="suhu_ruang" type="number" placeholder="Enter suhu Ruang" value=""/>
                            </div>
                            <div class="col-md-4">
                                <label class="small mb-1" for="suhu_chiller">Suhu Chiller</label>
                                <input class="form-control" name="suhu_chiller" id="suhu_chiller" type="number" placeholder="Enter suhu Chiller" value="" />
                            </div>
                            <div class="col-md-4">
                                <label class="small mb-1" for="suhu_freezer">Suhu Freezer</label>
                                <input class="form-control" name="suhu_freezer" id="suhu_freezer" type="number" placeholder="Enter suhu Freezer" value="" />
                            </div>
                        </div>
                        <div class="mb-3">
                            <label class="small mb-1" for="inputStatus">Status</label>
                            <input class="form-control" name="status" id="inputStatus" type="text" placeholder="Enter suhu status"></input>
                        </div>
                        <div class="mb-3">
